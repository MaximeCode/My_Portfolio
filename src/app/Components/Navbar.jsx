...
export default function Navbar() {
  ...
  return (
    <nav className="max-h-14 fixed top-5 left-0 right-0 z-50 bg-background ring-1 ring-secondary shadow-xl shadow-secondary/50 animate-nav rounded-full w-4/5 mx-auto px-3 lg:px-2 py-1 lg:py-2 flex items-center justify-between">
